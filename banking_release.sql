...
INSERT INTO `clients` VALUES (1,'Jimmy','Page','zoso','qwerty',8030,11000),(2,'John','Lennon','beatles','lalala',100,1000),(3,'Azamat','Marklenov','azabraza','neangime',50200,100),(4,'Jackie','Chan','whoami','kiyaa',0,60100),(5,'Brad','Pitt','bradyy','fury',10020,70000),(8,'Robert','Plant','ledzeppelin','ledzeppelin',0,50000),(9,'Nurkal','Tursunbekov','nurkal1611','nur67775',1000,0),(10,'Atabek','Shamshidinov','atabek','qwerty123',500100,0),(11,'Kalyibek','Kenenbaev','kkaly','123',1200,0),(12,'qwe','Ramzan','qwe','Kadyrov',0,0),(13,'Tilek','Joldoshbek','tilya','qwerty',3000,0),(14,'erlan','chodurov','xuvoss','12345',99999,0),(15,'Altynbek','Amytov','takenoff','takeshka',0,0),(16,'Asylbek','Asylbekov','asylka123','trololo',2999,5000),(17,'Balajan','Balajanov','bpp','pass123',3333,2324),(19,'Toktobek','Kenenbaev','tkenenbaev','3333',20000,400000);
...
CREATE TABLE `credit_requests` (
  `idcredit_requests` int NOT NULL AUTO_INCREMENT,
  `sum` float NOT NULL,
  ...
  PRIMARY KEY (`idcredit_requests`),
  KEY `creditor_idx` (`creditor_username`),
  CONSTRAINT `creditor` FOREIGN KEY (`creditor_username`) REFERENCES `clients` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `credit_requests` VALUES (21,50000,'Leonardo Dicaprio','Hollywood ','Los-Angeles','USD','bradyy'),(22,600000,'Daniel Namazbekov','Gagarin 127','Bishkek','KGS','asylka123');
...
INSERT INTO `credits` VALUES (19,10000,'KGS','2022-02-19',11),(20,50000,'USD','2022-02-19',2),(21,400000,'KGS','2022-02-19',15),(22,6000,'USD','2022-02-20',9),(27,10000,'USD','2022-02-22',1);
...
-- Dump completed on 2022-02-22 18:22:26
